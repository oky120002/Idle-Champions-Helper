...
import { computeCarryDps, computeLevelCurve } from '../../../../src/domain/simulator/baseDps'
import type { ResolvedHeroAbilityProfile } from '../../../../src/domain/abilities/abilityModel'
