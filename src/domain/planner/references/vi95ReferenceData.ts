...
// 完整游戏实测调研见 docs/research/gameplay/champion-mechanics/095-vi.md（researchDoc 字段关联）。
...
export const vi95ReferenceData = {
  ...
  researchDoc: 'docs/research/gameplay/champion-mechanics/095-vi.md',
  rawDescription: {
    naturalLanguage:
  ...
  snapshots: [
    {
      ...
      expected: {
        ...
        calibrationTarget: {
          ...
          tolerance: '< 30%（16384×576×1.2×2.578≈2.92e7 倍，研究 flat-factor 分解非代码产出，见 095-vi.md）',
        },
      },
      mock: {
        'context.formationHeroIds': '用户未提供完整阵型 heroId；测试用 geneutral mock carry + 5 名善良 mock + 蔚 support。用户补实测后替换',
      },
    },
  ],
