...
const UserHeroesPage = lazyNamedPage(() => import('../pages/UserHeroesPage'), 'UserHeroesPage')
...
const PlannerEvaluatePage = lazyNamedPage(() => import('../pages/PlannerEvaluatePage'), 'PlannerEvaluatePage')
      ...
      <main className={['site-main', isWorkbench ? 'site-main--workbench' : ''].filter(Boolean).join(' ')}>
        ...
        >
          <Routes>
            ...
            <Route path="/planner/evaluate" element={<PlannerEvaluatePage />} />
