...
export function buildFormationDraftPromptActions(options: BuildFormationDraftPromptActionsOptions) {
  return {
    handleRestoreRecentDraft: () => { restoreRecentDraft(options) },
    handleKeepDraftWithoutRestore: () => { keepDraftWithoutRestore(options) },
    handleDiscardRecentDraft: () => { discardRecentDraft(options) },
  }
}
...
function keepDraftWithoutRestore({
  draftPrompt,
  setDraftPrompt,
  setIsDraftPersistenceArmed,
  setDraftStatus,
