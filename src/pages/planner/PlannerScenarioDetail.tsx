        ...
        <>
          <div className="planner-scenario-selection__detail-hero">
            ...
            <p className="planner-scenario-selection__detail-subtitle">
              {record.adventure || t({ zh: '未绑定具体冒险名', en: 'No mapped adventure name' })}
            </p>
          </div>
            ...
            <div>
              ...
              <dd>
                {record.objectiveArea !== null
                  ? t({ zh: `${record.objectiveArea} 区完成`, en: `Finish at area ${record.objectiveArea}` })
                  : t({ zh: '自由游戏', en: 'Free play' })}
              </dd>
            </div>
            <div>
              <dt>{t({ zh: '场景', en: 'Scene' })}</dt>
              <dd>{record.scene || t({ zh: '未记录', en: 'Not recorded' })}</dd>
            </div>
            <div>
