...
import { loadChampionDetail, loadCollection, loadVersion } from '../../data/client'
import { resolveUserProfileSnapshot, type UserProfileResolution } from '../../data/user-profile-store'
import type { ChampionDetail, DataVersion } from '../../domain/types'
import { createUserProfileSnapshot } from '../../domain/user-profile/fixtures'
import type { OwnedHero } from '../../domain/user-profile/types'
import { UserHeroesPage } from '../UserHeroesPage'
import { championsFixture, enumsFixture, type ChampionsPageCollectionOverrides } from '../champions/championsPageTestData'
...
vi.mock('../../data/user-profile-store', async () => {
  const actual =
    await vi.importActual<typeof import('../../data/user-profile-store')>('../../data/user-profile-store')
