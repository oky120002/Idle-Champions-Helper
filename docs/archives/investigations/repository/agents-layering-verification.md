...
- `docs/README.md` 只做总入口，不做总清单；各主题维护自己的局部 `README.md`。

## 处理

- 收敛了 `AGENTS.md`，明确不再重复全局通用规则。
- 收敛了 `docs/README.md`，只保留读取顺序、专题入口、放置规则和命名约定。
- 新增 `docs/product/README.md`、`docs/research/README.md`、`docs/specs/modules/README.md`、`docs/archives/investigations/README.md` 作为渐进式加载入口。
