...
- 接入评分（globalBuff add pool 合并、effect_def 解引用两通道、type1 active 过滤、保守丢弃）：`docs/specs/modules/planner/mechanic-isolation.md` BonusProvider + `docs/specs/modules/planner/simulator.md` 加成聚合
