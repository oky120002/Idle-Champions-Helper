...
| 装备（loot-catalog，4044 item） | hero_dps×160 + global_dps×688 + health×104（equipmentMult，enchant `(1+enchant/250)` 缩放；global_dps 进 globalBuff 通道，health 进 survival:hero 池） | **大头未接**：buff_upgrade×1824、reduce_ultimate_cooldown×608、buff_ultimate×272、gold×12、crit×8 |
...
- 装备：`buff_upgrade`×1824、`reduce_ultimate_cooldown`×608、`buff_ultimate`×272、`gold`×12、`crit`×8——**装备加成大头未接**（equipmentMult 接 hero_dps+global_dps+health，余维度未接）。
