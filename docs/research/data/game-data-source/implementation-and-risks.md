...
- 最小可运行骨架：`scripts/fetch-idle-champions-definitions.ts`、`scripts/normalize-idle-champions-definitions.ts`、`scripts/build-idle-champions-data.ts`、`scripts/data/manual-overrides.json`。
