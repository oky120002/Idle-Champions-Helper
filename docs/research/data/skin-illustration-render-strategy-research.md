...
> 2026-04-16 补充：本文负责回答“路线为什么这样选”。如果你要看仓库当前已经落地成什么样、坐标系怎样修、默认选哪个 pose / slot、人工覆盖未来应该加在哪，请看 `docs/research/data/skin-illustration-render-pipeline-research.md`。
