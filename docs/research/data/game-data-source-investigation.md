...
- 阵型布局覆写或补丁
- 变体限制文本整理
- `language_id=7` 尚未覆盖到的中文名 / 中文标签缺口
- 页面筛选标签
- 推荐逻辑需要的派生规则
...
- 2026-04-13 已追加核实 `language_id=7` 的官方中文链路，详见 `docs/research/data/language-id-7-chinese-definitions-research.md`
- 因此“中文名”不再默认全部走人工维护，而是优先取官方中文，再对缺口做手工补充
...
4. **保留人工补充层，阵型布局和变体说明不要强行全靠原始 definitions 自动生成。**
   - 2026-04-13 之后，阵型布局已确认可以自动提取；这里的“人工补充层”主要改成必要覆写，而不是继续手工录全量布局。
