...
- 作用：沉淀官方 definitions 里升级 / 专长 / 皮肤字段的实际落点，供详情页核对。
...
- `hero_feat_defines`：按 `hero_id` 可拿到全部专长：`id`、`order`、`name`、`description`、`rarity`、`graphic_id`、`effects`、`sources`、`properties`、`collections_source`。
