...
| `PageWorkbenchShell` | `src/components/workbench/PageWorkbenchShell.tsx` | 全站统一桌面工作台壳层 | 统一合并工具条、左抽屉开合、无左栏隐藏模式、双栏内滚和桌面锁滚 | `ChampionsPage.tsx`、`UserHeroesPage.tsx`、`IllustrationsPage.tsx`、`PetsPage.tsx`、`VariantsPage.tsx`、`FormationPage.tsx`、`PresetsPage.tsx`、`PlannerPage.tsx`、`PlannerEvaluatePage.tsx`、`UserDataPage.tsx`、`ChampionDetailPage.tsx`、`AnimationAuditPage.tsx`、`SearchPage.tsx` |
| `WorkbenchScaffold` | `src/components/workbench/WorkbenchScaffold.tsx` | 工作台内部稳定展示骨架 | 统一 toolbar mark、标题 copy、badge、复制链接按钮、sidebar header、content stack 和筛选结果头 | `ChampionsPage.tsx`、`UserHeroesPage.tsx`、`IllustrationsPage.tsx`、`PetsPage.tsx`、`VariantsPage.tsx`、`FormationPage.tsx`、`PresetsPage.tsx`、`PlannerPage.tsx`、`PlannerEvaluatePage.tsx`、`UserDataPage.tsx`、`AnimationAuditPage.tsx` |
