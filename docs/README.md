...
文档按回答的问题分类，分为六类活跃资产与一类历史归档。改代码前看 `specs/`，查事实看 `research/`，照步骤操作看 `runbooks/`，有新需求想法看 `requirements/`。
...
| Requirement 需求 | [`requirements/`](./requirements/) | 将来可能做什么（未承诺执行） | 有新需求想法但尚未确认启动 |
