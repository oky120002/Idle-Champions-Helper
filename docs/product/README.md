...
- 作用：只在需要产品范围、长期边界或全局规则时加载本目录。

## 当前文档

- `docs/product/idle-champions-roadmap.md`：项目价值、定位、用户、范围、阶段路线、技术方向。
...
- 判断“这次要做什么、不做什么、先后顺序是什么”：读 `docs/product/idle-champions-roadmap.md`。
