...
- **P0 清零**：本轮无 P0。
- **P1 登记**：3 项（signal-coverage 假门 / 192 MB .bin 无 LFS / build 派生产物无 schema），均带动作 + ROI + 影响面 + 决策点。
